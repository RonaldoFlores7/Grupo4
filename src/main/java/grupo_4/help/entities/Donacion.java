...
public class Donacion {
    ...
    private TipoAyuda ta;
    public Donacion() {}

    public Donacion(int idDonacion, String telefono, double montoTransferido, String descripcionDonac, LocalDate fechaDonacion, String estado, Usuario us, Campania ca, TipoAyuda ta) {
    ...
    public TipoAyuda getTa() {
        return ta;
    }

    public void setTa(TipoAyuda ta) {
        this.ta = ta;
    }
}
